...
-- Dumping data for table autodealer.featured_image: ~5 rows (approximately)
...
INSERT INTO `featured_image` (`id`, `path`, `thumb_path`, `img_name`, `user_id`, `description`) VALUES
	...
	(8, '\\336920057\\Featured Images\\Desert.jpg', '\\336920057\\Featured Images\\thumbnail_Desert.jpg', 'Desert.jpg', 336920057, 'vffgbfsbf');
/*!40000 ALTER TABLE `featured_image` ENABLE KEYS */;


-- Dumping structure for table autodealer.featured_image_config
CREATE TABLE IF NOT EXISTS `featured_image_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `crop_width` int(11) DEFAULT NULL,
  `crop_height` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_featured_image_config_auth_user` (`user_id`),
  CONSTRAINT `FK_featured_image_config_auth_user` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Dumping data for table autodealer.featured_image_config: ~0 rows (approximately)
/*!40000 ALTER TABLE `featured_image_config` DISABLE KEYS */;
INSERT INTO `featured_image_config` (`id`, `crop_width`, `crop_height`, `user_id`) VALUES
	(1, 700, 700, 336920057);
/*!40000 ALTER TABLE `featured_image_config` ENABLE KEYS */;
...
INSERT INTO `slider_image` (`id`, `path`, `thumb_path`, `img_name`, `user_id`, `description`) VALUES
	...
	(18, '\\336920057\\Slider Images\\Lighthouse.jpg', '\\336920057\\Slider Images\\thumbnail_Lighthouse.jpg', 'Lighthouse.jpg', 336920057, 'bhbhb');
/*!40000 ALTER TABLE `slider_image` ENABLE KEYS */;


-- Dumping structure for table autodealer.slider_image_config
CREATE TABLE IF NOT EXISTS `slider_image_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `crop_width` int(11) DEFAULT NULL,
  `crop_height` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_slider_image_config_auth_user` (`user_id`),
  CONSTRAINT `FK_slider_image_config_auth_user` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Dumping data for table autodealer.slider_image_config: ~0 rows (approximately)
/*!40000 ALTER TABLE `slider_image_config` DISABLE KEYS */;
INSERT INTO `slider_image_config` (`id`, `crop_width`, `crop_height`, `user_id`) VALUES
	(1, 600, 600, 336920057);
/*!40000 ALTER TABLE `slider_image_config` ENABLE KEYS */;
