...
public class ExteriorColor {
    ...
    private PrimaryRgbCode primaryRgbCode;
    @JsonProperty("secondary_rgb_code")
    private SecondaryRgbCode secondaryRgbCode;
    @JsonIgnore
     ...
     */
    @JsonProperty("primary_rgb_code")
    public PrimaryRgbCode getPrimaryRgbCode() {
     ...
     */
    @JsonProperty("primary_rgb_code")
    public void setPrimaryRgbCode(PrimaryRgbCode primaryRgbCode) {
     ...
     */
    @JsonProperty("secondary_rgb_code")
    public SecondaryRgbCode getSecondaryRgbCode() {
     ...
     */
    @JsonProperty("secondary_rgb_code")
    public void setSecondaryRgbCode(SecondaryRgbCode secondaryRgbCode) {
