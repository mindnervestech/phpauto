...
@Entity
public class ClickyVisitorTrafficSource extends Model {
	...
	public static Finder<Long,ClickyVisitorTrafficSource > find = new Finder<>(Long.class,ClickyVisitorTrafficSource.class);
	
	public static List<ClickyVisitorTrafficSource > getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	
	public static List<ClickyVisitorTrafficSource> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	public static List<ClickyVisitorTrafficSource > getfindAll() {
		return find.all();
	...
	public static ClickyVisitorTrafficSource  findById(Long id) {
		return find.byId(id);
	}
