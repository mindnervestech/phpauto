...
@Entity
public class PlanSchedule extends Model {
	...
	public static Finder<Long,PlanSchedule> find = new Finder<>(Long.class,PlanSchedule.class);
	
	
	
	public static PlanSchedule findById(Long id) {
		return find.byId(id);
	}
	
	public static List<PlanSchedule> findAllData() {
		return find.all();
	}
	
	public static List<PlanSchedule> findAllByUser(AuthUser user) {
		return find.where().eq("user", user).findList();
	}
	
	public static List<PlanSchedule> findAllByLocation(Long locationId) {
