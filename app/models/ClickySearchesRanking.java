...
@Entity
public class ClickySearchesRanking extends Model {
	...
	public static Finder<Long,ClickySearchesRanking> find = new Finder<>(Long.class,ClickySearchesRanking.class);
	
	public static List<ClickySearchesRanking> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	
	public static List<ClickySearchesRanking> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	
	public static List<ClickySearchesRanking> getfindAll() {
		return find.all();
	}
	
	
	public static ClickySearchesRanking findById(Long id) {
		return find.byId(id);
	}
	
	
	public static List<ClickySearchesRanking> findByTitleAndDate(String title, Date startdate, Date enddate) {
