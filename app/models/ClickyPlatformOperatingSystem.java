...
@Entity
public class ClickyPlatformOperatingSystem extends Model{
	...
	public static Finder<Long,ClickyPlatformOperatingSystem> find = new Finder<>(Long.class,ClickyPlatformOperatingSystem.class);
	
	public static List<ClickyPlatformOperatingSystem> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	
	public static List<ClickyPlatformOperatingSystem> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	public static List<ClickyPlatformOperatingSystem> getfindAll() {
		return find.all();
	...
	public static ClickyPlatformOperatingSystem findById(Long id) {
		return find.byId(id);
	}
	
	public static List<ClickyPlatformOperatingSystem> findByTitle(String title) {
		return find.where().eq("title", title).findList();
	}
	
	public static List<ClickyPlatformOperatingSystem> findByTitleAndDate(String title, Date startdate, Date enddate) {
