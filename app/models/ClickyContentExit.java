...
@Entity
public class ClickyContentExit extends Model {
	...
	public static Finder<Long,ClickyContentExit> find = new Finder<>(Long.class,ClickyContentExit.class);
	
	public static List<ClickyContentExit> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	public static List<ClickyContentExit> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	
	public static List<ClickyContentExit> getfindAll() {
		return find.all();
	}
	
	
	public static ClickyContentExit findById(Long id) {
		return find.byId(id);
	}
