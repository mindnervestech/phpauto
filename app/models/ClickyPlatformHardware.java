...
@Entity
public class ClickyPlatformHardware extends Model {
	...
	public static Finder<Long,ClickyPlatformHardware> find = new Finder<>(Long.class,ClickyPlatformHardware.class);
	
	public static List<ClickyPlatformHardware> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	
	public static List<ClickyPlatformHardware> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	public static List<ClickyPlatformHardware> getfindAll() {
		return find.all();
	...
	public static ClickyPlatformHardware findById(Long id) {
		return find.byId(id);
	}
	
	
	public static List<ClickyPlatformHardware> findByTitle(String title) {
		return find.where().eq("title", title).findList();
	}
	
	public static List<ClickyPlatformHardware> findByTitleAndDate(String title, Date startdate, Date enddate) {
