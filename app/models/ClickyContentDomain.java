...
@Entity
public class ClickyContentDomain extends Model {
	...
	public static Finder<Long,ClickyContentDomain> find = new Finder<>(Long.class,ClickyContentDomain.class);
	
	public static List<ClickyContentDomain> getAll(Date sDate,Date eDate) {
	...
	public static ClickyContentDomain findById(Long id) {
		return find.byId(id);
	}
