...
@Entity
public class ClickyPlatformBrowser extends Model {
	...
	public static Finder<Long,ClickyPlatformBrowser> find = new Finder<>(Long.class,ClickyPlatformBrowser.class);
	
	public static List<ClickyPlatformBrowser> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	
	public static List<ClickyPlatformBrowser> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	public static List<ClickyPlatformBrowser> getfindAll() {
		return find.all();
	...
	public static ClickyPlatformBrowser findById(Long id) {
		return find.byId(id);
	}
	
	
	public static List<ClickyPlatformBrowser> findByTitle(String title) {
