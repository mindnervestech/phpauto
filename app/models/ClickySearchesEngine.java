...
@Entity
public class ClickySearchesEngine extends Model {
	...
	public static Finder<Long,ClickySearchesEngine> find = new Finder<>(Long.class,ClickySearchesEngine.class);
	
	public static List<ClickySearchesEngine> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	public static List<ClickySearchesEngine> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	
	public static List<ClickySearchesEngine> getfindAll() {
		return find.all();
	}
	
	
	public static ClickySearchesEngine findById(Long id) {
		return find.byId(id);
	}
	public static List<ClickySearchesEngine> findByTitleAndDate(String title, Date startdate, Date enddate) {
