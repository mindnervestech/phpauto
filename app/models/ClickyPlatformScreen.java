...
@Entity
public class ClickyPlatformScreen extends Model {
	...
	public static Finder<Long,ClickyPlatformScreen> find = new Finder<>(Long.class,ClickyPlatformScreen.class);
	
	public static List<ClickyPlatformScreen> getAll(Date sDate,Date eDate) {
		return find.where().between("saveDate", sDate, eDate).findList();
	}
	
	
	public static List<ClickyPlatformScreen> getAllData(Date sDate) {
		return find.where().eq("saveDate", sDate).findList();
	}
	
	public static List<ClickyPlatformScreen> getfindAll() {
		return find.all();
	...
	public static ClickyPlatformScreen findById(Long id) {
		return find.byId(id);
	}
	
	
	public static List<ClickyPlatformScreen> findByTitle(String title) {
		return find.where().eq("title", title).findList();
	}
	
	public static List<ClickyPlatformScreen> findByTitleAndDate(String title, Date startdate, Date enddate) {
