...
@Entity
public class ClickyContentMedia extends Model {
	...
	public static Finder<Long,ClickyContentMedia> find = new Finder<>(Long.class,ClickyContentMedia.class);
	
	public static List<ClickyContentMedia> getAll(Date sDate,Date eDate) {
	...
	public static ClickyContentMedia findById(Long id) {
		return find.byId(id);
	}
