  ...
  angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
    '$scope', '$injector', 'ngDialog', function($scope, $injector, ngDialog) {
        ...
        $scope.gridColumnOption = {
            'column_name' : '',
            'field' : '',
            'grid_derived_col' : false,
            'col_id' : ''
        };

       $scope.addRow = function() {
       ngDialog.openConfirm({template: 'src/template/gridcolumnequation.html',
          scope: $scope //Pass the scope object if you need to access in the template
        }).then(
          function(value) {
            //save the contact form
            $scope.gridColumnOption.col_id = String.fromCharCode(asciCode); 
            $scope.columnOptions.push($scope.gridColumnOption);
            $scope.gridColumnOption = {};
            $scope.gridColumnOption.grid_derived_col =  false;
            asciCode++;
          },
          function(value) {
      ...
      if ($scope.formObject.column == null) {
        $scope.formObject.column = [];
      }
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[label, description, placeholder, required, isRepeatable, options, validation, multiple, minLength, maxLength, disableWeekends, maxDate, requireConfirmation, readOnly, minRange, maxRange, nextXDays, performCreditCheck, cprCountry, logic, category, pointRules, conversionType,imageUrl,key, columnOptions, equation, displayGrid, savecrm]', function() {
          ...
          formObject.equation = $scope.equation;
          ...
          formObject.column = $scope.column;
      ...
      return $scope.data = {
        ...
        rollback: function() {
          ...
          $scope.column = this.model.column;
...
(function() {
  angular.module('builder.directive', ['builder.provider', 'builder.controller', 'builder.drag', 'validator']).directive('richText', [
      ...
      return {
        ...
        link: function(scope, element, attrs) {
          scope.fields = function() {
           ...
           // if (element.parent().parent().parent().parent().is(':visible') === true) {
    ...
    '$injector', function($injector) {
      ...
      return {
       ...
       template: "<div class='form-horizontal'>\n  <div class = 'row' ng-repeat=\"object in formObjects\"\n ><div class = 'col-sm-1'>  &nbsp; \n </div> <div  class='col-sm-9 fb-form-object-editable clickPosition' fb-form-object-editable=\"object\">\n </div> <div class = 'col-sm-1'><div fb-form-object-editable-view=\"object\" class='fa fa-edit fb-form-object-editable-view' style = 'margin-top:15px; padding:5px;' type=\"button\" onclick=\"\" value=\"Spam\"></div> </div></div>\n </div>",
        link: function(scope, element, attrs) {
          ...
          console.log('$builder.forms',$builder.forms[scope.formName]);
          ...
          return $drag.droppable($(element), {
            move: function(e) {
              ...
              if (beginMove) {
                $("div.fb-form-object-editable-view").popover('hide');
                beginMove = false;
              }
  ...
  ]).directive('fbFormObjectEditableView', [
    '$injector', function($injector) {
      ...
      return {
        ...
        scope: {
          formObject: '=fbFormObjectEditableView'
        },
        link: function(scope, element) {
         ...
         /* $drag.draggable($(element), {
          ...
          $(element).on('show.bs.popover', function() {
            ...
            $("div.fb-form-object-editable-view:not(." + popover.id + ")").popover('hide');
            ...
            if ($popover.length > 0) {
              ...
              $popover.css({
                position: 'absolute',
                top: popoverTop+element.clientY
              });
              $popover.show();
              setTimeout(function() {
                $popover.addClass('in');
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertComponent = function(name, component) {
      ...
      result = {
        ...
        key: (_ref11 = component.key) != null ? _ref11 : '',
        ...
        columnOptions: (_ref12 = component.columnOptions) != null ? _ref12 : [],
        equation: (_ref12 = component.equation) != null ? _ref13 : '',
    ...
    this.convertFormObject = function(name, formObject) {
      ...
      result = {
        ...
        description: (_ref26 = formObject.description) != null ? _ref26 : component.description,
        key: (_ref3 = formObject.key) != null ? _ref3 : component.key,
        imageUrl: (_ref25 = formObject.imageUrl) != null ? _ref25 : component.imageUrl,
