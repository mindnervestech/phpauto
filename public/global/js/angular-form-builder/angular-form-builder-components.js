  ...
  angular.module('builder.components', ['builder', 'validator.rules']).config([
    ...
    $builderProvider.registerComponent('date', {
      ...
      $builderProvider.registerComponent('inventorysearch', {
          ...
          disableWeekends: false,
          readOnly: false,
          template: "<div class=\"col-md-12\"><h3>&nbsp;&nbsp;&nbsp;&nbsp;<a ng-click=\"editLeadInfo('Search Title')\" ng-if=\"showSaveButton == 'Edit'\"><i class=\"glyphicon glyphicon-edit\"></i></a></h3><div class=\"col-md-4\"><div class=\"col-md-12\"><label>{{setjson.searchSubTitle}}</label>&nbsp;&nbsp;&nbsp;&nbsp;<a ng-click=\"editLeadInfo('Search Sub Title')\" ng-if=\"showSaveButton == 'Edit'\"><i class=\"glyphicon glyphicon-edit\"></i></a></div><div ng-show=\"isStockError\" style=\"color: red;\">Not Found.</div><div style=\"margin: 10px 0 10px 0;\"><input type=\"text\" class=\"col-md-12\" ng-model=\"stockRp.stock\" style=\"margin-bottom: 7px;\" disabled=\"disabled\" /></div><div style=\"margin: 10px 0 10px 0;\"><input type=\"text\" class=\"col-md-12\" ng-model=\"stockRp.designer\" style=\"margin-bottom: 7px;\" disabled=\"disabled\" placeholder=\"Title\"/></div><div style=\"margin: 10px 0 10px 0;\"><input type=\"text\" class=\"col-md-12\" style=\"margin-bottom: 7px;\" ng-model=\"stockRp.designer\" disabled=\"disabled\" placeholder=\"Model\"/></div><div style=\"margin: 10px 0 10px 0;\"><input type=\"text\" class=\"col-md-12\" ng-model=\"stockRp.year\" style=\"margin-bottom: 7px;\" disabled=\"disabled\" placeholder=\"Year\"/></div></div><div class=\"col-md-7\" style=\"border-radius: 11px / 13px;border: 1px solid #e5e5e5;box-shadow: 0 0 5px;font-family: 'Open Sans', sans-serif;padding-left: 0px;\"><div><div class=\"col-md-5\" style=\"padding-left: 0px;\"><img class=\"preview col-md-5\" style=\"margin-top: 7px;width: 136px;height: 121px;\" src=\"/assets/images/car.jpg\"></div><div class=\"col-md-7\" style=\"padding: 0px;\"><label class=\"col-md-12\" style=\"font-size: 20px;padding: 0px;\">Vehicle Name</label><label class=\"col-md-6\">BodyStyle:</label><label class=\"col-md-6\">-</label><label class=\"col-md-6\">price:</label><label class=\"col-md-6\">_</label><label class=\"col-md-6\">Engin:</label><label class=\"col-md-6\">_</label><label class=\"col-md-6\">year:</label><label class=\"col-md-6\">_</label></div></div></div><div class=\"col-md-1\" style=\"font-size: 29px;margin-top: 54px;\" ng-show=\"stockWiseData.length  > 1\"><a ng-click=\"removeLead($index)\"><span class=\"glyphicon glyphicon-trash\"></span></a></div></div><div class=\"col-md-12\" style=\"text-align: center;font-size: 17px;\"><a>ADD ITEM</a> <div class='col-sm-12'> <hr> </div></div>",
          popoverTemplateUrl: '/dealer/template/textInput.html'
        });
