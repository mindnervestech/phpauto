angular.module('formlyIonic', ['formly'], ["formlyConfigProvider", function configFormlyIonic(formlyConfigProvider) {
    ...
    angular.forEach(['checkbox', 'input', 'radio', 'range', 'textarea', 'toggle', 'select', 'floating-input', 'stacked-input', 'inline-input','signature','ui-grid','image','financialcalculator','daterange','autocompleteText','contactssearch','inventorysearch','fileuploaders','timerange'], function (fieldName) {
...
$templateCache.put("fields/range.html","<div class=\"item range\" ng-class=\"\'range-\' + options.templateOptions.rangeClass\"><span class=\"col-sm-3\">{{options.templateOptions.label}}</span> <i class=\"icon\" ng-if=\"options.templateOptions.minIcon\" ng-class=\"options.templateOptions.minIcon\"></i> <input type=\"range\" min=\"{{options.templateOptions.min}}\" max=\"{{options.templateOptions.max}}\" step=\"{{options.templateOptions.step}}\" value=\"{{options.templateOptions.value}}\" ng-model=\"model[options.key]\"> <i class=\"icon\" ng-if=\"options.templateOptions.maxIcon\" ng-class=\"options.templateOptions.maxIcon\"></i></div>");
$templateCache.put("fields/select.html","<label class=\"item item-input item-select form-group col-sm-12\" style=\"padding-left: 0px;\"><div class=\"input-label form-group col-sm-2\">{{to.label}}</div><div class=\"col-sm-4 form-group\"><select class=\"col-sm-10\" ng-model=\"model[options.key]\" ng-options=\"option[to.valueProp || \'value\'] as option[to.labelProp || \'name\'] group by 			  option[to.groupProp || \'group\'] for option in to.options\"></select></div></label>");
...
$templateCache.put("fields/autocompleteText.html","<div class=\"form-group col-sm-12\" id=\"{{formName+index | nospace}}\">\n    <label class=\"col-sm-2 control-label\" for=\"{{formName+index}}\" ng-class=\"{'fb-required':required}\" style=\"padding-left: 0px;\"><i ng-if =\"formObject.logic.component\" id=\"hasLogic\" class=\"fa fa-random label-logic\"></i>{{options.templateOptions.label}}</label>\n    <div class=\"col-sm-6\">\n        <input type=\"text\" id=\"autocomplete\" ng-model=\"model['addressBar']\" ng-change=\"test()\" class=\"form-control m-b\" placeholder=\"{{placeholder}}\"/>\n    </div>");
...
$templateCache.put("fields/fileuploaders.html","<div class=\"form-group col-sm-12\"><label class=\"col-sm-2 control-label\" style=\"padding-left: 0px;\">{{options.templateOptions.label}}</label><div class=\"col-sm-6\"><input type=\"file\" ng-model=\"model['files']\" name=\"logoFile\" ng-file-select=\"onLogoFileSelect($files)\" accept=\"application/msword,application/pdf\"/></div>");
$templateCache.put("fields/timerange.html","<div class=\"form-group col-sm-12\"><label class=\"col-sm-2 control-label\" style=\"padding-left: 0px;\">{{options.templateOptions.label}}</label><div class=\"form-group col-sm-4 prepend-icon\"><input type=\"text\" name=\"timepicker\" class=\"timepicker form-control hasDatepicker\" ng-model=\"model['timeSet']\"  placeholder=\"Choose a time...\" ng-click=\"showtimepick()\" data-format=\"am-pm\" id=\"bestTimes\"><i class=\"icon-clock\"></i></div>");
