...
.controller('RequestMoreInfoCtrl', ['$scope','$http','$location','$filter', function ($scope,$http,$location,$filter) {
  ...
  $scope.gridOptions = {
 		 ...
 		 $scope.gridOptions.columnDefs = [
 		                                 ...
 		                                 { name: 'model', displayName: 'Model',enableFiltering: false, width:'15%',cellEditableCondition: false,
 		                                 },
 		                                 { name: 'make', displayName: 'Make',enableFiltering: false, width:'15%',cellEditableCondition: false,
 		                                 },
 		                                 ...
 		                                 { name: 'requestDate', displayName: 'Date',enableFiltering: false, width:'10%',cellEditableCondition: false,
 		                                 },
     		                                 ];
